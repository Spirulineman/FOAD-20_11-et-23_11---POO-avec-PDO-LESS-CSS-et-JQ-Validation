...
<body>
    ...
    <table>
        <thead>
                <th id="th_1">Nombre d'élèves : </th><th id="th_2"><?= count($all_eleves) ?></th><th id="td_moy">Moyenne de la Classe : <th><b id="td_moy_number"><?= $calc_moyenne->getCalc_moyenne()?></b></th>
        </thead>
        ...
        <tfoot>
                    <th id="th_1">Nombre d'élèves : </th><td id="th_2"><?= count($all_eleves) ?></td><th id="td_moy">Moyenne de la Classe : <th><b id="td_moy_number"><?= $calc_moyenne->getCalc_moyenne()?></b></td>
                </tr>
        </tfoot>
        <tfoot>
            <tr id="tr">
